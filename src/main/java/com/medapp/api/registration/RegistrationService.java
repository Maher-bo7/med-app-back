...
import com.medapp.api.email.EmailSender;
...
import com.medapp.api.service.UserService;
    ...
    public String register (RegistrationRequest request){
       ...
       if(!isValidEmail){
        ...
        public String confirmToken(String token){
            ...
            if(confirmationToken.getConfirmedAt()!=null){throw new IllegalStateException("email already taken");}
